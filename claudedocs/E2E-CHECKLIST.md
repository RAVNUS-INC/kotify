# E2E 검증 체크리스트 (HISTORICAL)

> **⚠️ HISTORICAL — NCP SENS 시절 검증 체크리스트.**
> 현행 배포 절차는 [deploy/README.md](../deploy/README.md) 를 참조하세요
> (U+ msghub 기반 Wizard 단계 포함).
>
> 본 문서의 Step 1 "NCP 사전 준비", Step 3 "NCP 정보 입력" 등은 현재와 다르며,
> 초기 검증 관점(발신번호 사전 등록, 인증 테스트, 장애 시나리오 등)의 레퍼런스로만
> 활용하세요.
